...
#     """
#     This manages how information is passed from the beam class to the diagram
#     drawer.
#     """
...
class BeamPlotter:
    ...
    def __init__(self, beam, beamPlotter = BasicBeamDiagram()):
        ...
        # TODO:
            # automatically get beam size
        
        self.plotter._initPlot(1)
        # self.xmin
    ...
    def plotSupports(self):
        ...
        for node in self.nodes:
            ...
            """
            This makes some big assumptinos about the shape of the system.
            """
            kwargs = {}
